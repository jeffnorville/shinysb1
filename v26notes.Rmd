...
- Adding function to "turn off" data packages if erroneous, outdated, whatever
...
## Whiteboard shots:
![photo 1 of 2]('~/R/shinysb1/figures/20160629rv1de2.png')
![photo 1 of 2](figures/20160629rv1de2.png)


![photo 2 of 2]('~/R/shinysb1/figures/20160629rv2de2.png')
